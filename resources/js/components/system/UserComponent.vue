      ...
      <div class="main-container p-5 pt-3 ">
        ...
        <div class="col-md-12">
          <div class="m-auto text-right">
            <button class="button create-btn" v-on:click="create">Create New <i class="fas fa-solid fa-plus"></i></button>
          </div>
        </div>
        </div>
        ...
        <div id="people">
            <v-client-table  :data="tableData" :columns="columns" :options="options">
              ...
              <template v-slot:actions="{ row }">
                <button class="button edit-btn" v-on:click="edit(row)"> <i class="fas fa-edit text-light"></i> Edit</button>
                <button class="button change-password-btn" v-on:click="changePasssword(row)"><i class="fas fa-user-shield text-light"></i> Change Password</button>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="button create-btn" v-on:click="store" v-if="!isEdit">Create</button>
